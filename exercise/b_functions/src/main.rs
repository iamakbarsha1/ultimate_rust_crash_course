...
// fn volume(width: i32, height: i32, depth: i32) -> f64 {
fn volume(width: i32, height: i32, depth: f64) -> f64 {
    // width * height * depth
    (width * height) as f64 * depth
    // Reason for cast: width * height is i32; must convert to f64 to multiply with depth
}
